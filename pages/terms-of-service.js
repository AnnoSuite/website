  ...
  return (
    <Container>
      ...
      <Row as={"main"}>
        <Col>
          <Heading as="h1">
            <span className={"primaryMessage"}>Terms of Service</span>
          </Heading>
          <P>
            These terms and conditions outline the rules and regulations for the
            use of AnnoSuite's Website.
          </P>
          <P>
            By accessing this website we assume you accept these terms and
            conditions in full. Do not continue to use AnnoSuite's website if
          ...
          <P>
            We employ the use of cookies. By using AnnoSuite's website you
            consent to the use of cookies in accordance with AnnoSuite's privacy
            policy.
          </P>
          <P>
          ...
          <P>
            Unless otherwise stated, AnnoSuite and/or it's licensors own the
            intellectual property rights for all material on AnnoSuite. All
            intellectual property rights are reserved. You may view and/or print
            pages from https://www.annosuite.com for your own personal use
            subject to restrictions set in these terms and conditions.
          </P>
          <P>You must not:</P>
          <ol>
            <li>Republish material from https://www.annosuite.com</li>
            <li>
              Sell, rent or sub-license material from https://www.annosuite.com
            </li>
            <li>
              Reproduce, duplicate or copy material from
              https://www.annosuite.com
            </li>
          </ol>
          <P>
            Redistribute content from AnnoSuite (unless content is specifically
            made for redistribution).
          </P>
          <Heading>User Comments</Heading>
          <ol>
            ...
            <li>
              ...
              ('Comments') in areas of the website. AnnoSuite does not screen,
              ...
              ofAnnoSuite, its agents or affiliates. Comments reflect the view
              and opinion of the person who posts such view or opinion. To the
              extent permitted by applicable laws AnnoSuiteshall not be
            ...
            <li>
              AnnoSuitereserves the right to monitor all Comments and to remove
            ...
            <li>
              You hereby grant to <strong>AnnoSuite</strong> a non-exclusive
          ...
          <P>
            ...
            hyperlink outweighs the absence of AnnoSuite; and (d) where the link
          ...
          <P>
            ...
            <a
              href="mailto:nzrbeats@gmail.com"
              title="send an email to nzrbeats@gmail.com"
            >
              nzrbeats@gmail.com
            </a>
          ...
          <P>
            No use of AnnoSuite's logo or other artwork will be allowed for
