...
export const Taken = ({
  ...
  <svg
    ...
    src="https://42f2671d685f51e10fc6-b9fcecea3e50b3b59bdc28dead054ebc.ssl.cf5.rackcdn.com/illustrations/Taken_if77.svg"
  ...
  >
    ...
    <path
      ...
      fill="#fff"
    ></path>
    <circle cx="405.35" cy="486.08" r="6.51" opacity="0.2"></circle>
    <circle cx="442.37" cy="498.53" r="6.51" opacity="0.2"></circle>
    <ellipse
      cx="595.55"
      cy="603.56"
      rx="9.76"
      ...
      fill="#e0e0e0"
    ></ellipse>
    <circle cx="552.53" cy="487.52" r="9.76" fill="#fff"></circle>
    <circle cx="583.45" cy="472.17" r="4.88" fill="#fff"></circle>
    <g opacity="0.5">
      <g opacity="0.3">
        <path
      ...
      <path
        ...
        fill="#fff"
      ></path>
      <circle cx="418.35" cy="93.08" r="6.51" opacity="0.2"></circle>
      <circle cx="455.37" cy="105.53" r="6.51" opacity="0.2"></circle>
    </g>
    <path
    ...
    ></path>
    <g opacity="0.5">
      <rect x="110" y="257.85" width="3" height="17" fill="#47e6b1"></rect>
      <rect
        x="290"
        y="344.43"
        width="3"
    ...
    <g opacity="0.5">
      <rect x="830" y="177.85" width="3" height="17" fill="#47e6b1"></rect>
      <rect
        x="1010"
        y="264.43"
        width="3"
    ...
    <g opacity="0.5">
      <rect x="730" y="456.85" width="3" height="17" fill="#47e6b1"></rect>
      <rect
        x="910"
        y="543.43"
        width="3"
    ...
    <circle cx="723" cy="81.85" r="6" fill="#f55f44" opacity="0.5"></circle>
    <circle cx="6" cy="12.85" r="6" fill="#f55f44" opacity="0.5"></circle>
    <circle cx="186" cy="357.85" r="6" fill="#f55f44" opacity="0.5"></circle>
    <ellipse cx="234" cy="154.43" rx="34" ry="7" opacity="0.05"></ellipse>
    <ellipse cx="234" cy="207.43" rx="34" ry="7" opacity="0.05"></ellipse>
    <ellipse cx="621" cy="154.43" rx="34" ry="7" opacity="0.05"></ellipse>
    <ellipse cx="621" cy="207.43" rx="34" ry="7" opacity="0.05"></ellipse>
    <ellipse cx="432" cy="124.43" rx="34" ry="7" opacity="0.05"></ellipse>
    <ellipse cx="457" cy="51.43" rx="34" ry="7" opacity="0.05"></ellipse>
    <ellipse cx="392" cy="81.43" rx="34" ry="7" opacity="0.05"></ellipse>
    <ellipse cx="517" cy="94.43" rx="34" ry="7" opacity="0.05"></ellipse>
    <ellipse cx="432" cy="228.43" rx="34" ry="7" opacity="0.05"></ellipse>
  </svg>
);
